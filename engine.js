...
const COLS=['1.07','16.07','1.08','16.08','1.09','15.09','1.10','16.10','1.11','16.11','1.12','16.12','31.12',
  '1.01.27','16.01.27','1.02.27','16.02.27','1.03.27','16.03.27','1.04.27','16.04.27','1.05.27','16.05.27','1.06.27','16.06.27','1.07.27','16.07.27','1.08.27','16.08.27','1.09.27','16.09.27','1.10.27','16.10.27','1.11.27','16.11.27','1.12.27','16.12.27'];
const z=()=>Array(COLS.length).fill(0);
const MON_NAMES={'01':'Январь','02':'Февраль','03':'Март','04':'Апрель','05':'Май','06':'Июнь','07':'Июль','08':'Август','09':'Сентябрь','10':'Октябрь','11':'Ноябрь','12':'Декабрь'};
const MON_DAYS ={'01':31,'02':28,'03':31,'04':30,'05':31,'06':30,'07':31,'08':31,'09':30,'10':31,'11':30,'12':31};   // 2027 не високосный
...
const MONTHS=(()=>{
  ...
  COLS.forEach((c,i)=>{
    ...
    const key=numeric?(p[2]?p[1]+'.'+p[2]:p[1]):c;      // '07' это июль-2026, '07.27' — июль-2027
    const mm=numeric?p[1]:null;
    const day=numeric?+p[0]:1;
    const last=g[g.length-1];
    if(last&&last.key===key){ last.cols.push(i); last.days.push(day); }
    else g.push({key,name:(MON_NAMES[mm]||c)+(p[2]?" '"+p[2]:''),cols:[i],days:[day],len:MON_DAYS[mm]||31});
  });
...
const PERIODS=[
 ...
 ['2026-12-31',1],
 ['2027-01-01',15],['2027-01-16',16],
 ['2027-02-01',15],['2027-02-16',13],
 ['2027-03-01',15],['2027-03-16',16],
 ['2027-04-01',15],['2027-04-16',15],
 ['2027-05-01',15],['2027-05-16',16],
 ['2027-06-01',15],['2027-06-16',15],
 ['2027-07-01',15],['2027-07-16',16],
 ['2027-08-01',15],['2027-08-16',16],
 ['2027-09-01',15],['2027-09-16',15],
 ['2027-10-01',15],['2027-10-16',16],
 ['2027-11-01',15],['2027-11-16',15],
 ['2027-12-01',15],['2027-12-16',16]];
